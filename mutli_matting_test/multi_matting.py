...
def matting_imgs(imgspath, xmlspath, savepath, day, numconstraint=3500, name_bool=False, rate=0.1):
...
if __name__ == "__main__":
    ...
    for rate in rates:
        imgspath = '/defaultShare/share/wujl/83/online_data/daydata/JPEGImages'
        xmlspath = '/defaultShare/share/wujl/83/online_data/daydata/Annotations'
        savepath = '/defaultShare/share/wujl/83/online_data/cropdata_{}'.format(rate)
        p = matting_imgs(imgspath, xmlspath, savepath, day, numconstraint=20000000, name_bool=False, rate=rate)
        print('end')
